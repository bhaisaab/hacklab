...
import gtk
import logging
logger = logging.getLogger('gopu_lib')

from . helpers import get_builder, show_uri, get_help_uri
from . preferences import preferences

# This class is meant to be subclassed by GopuWindow.  It provides
...
class Window(gtk.Window):
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated BaseGopuWindow object.
        """
        builder = get_builder('GopuWindow')
        new_object = builder.get_object("gopu_window")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a GopuWindow object with it in order to finish
        initializing the start of the new GopuWindow instance.
        """
        ...
        try:
            ...
            LaunchpadIntegration.set_sourcepackagename('gopu')
        except ImportError:
            pass
    ...
    def on_mnu_about_activate(self, widget, data=None):
        """Display the about box for gopu."""
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for gopu."""
    ...
    def on_mnu_close_activate(self, widget, data=None):
        """Signal handler for closing the GopuWindow."""
        self.destroy()

    def on_destroy(self, widget, data=None):
        """Called when the GopuWindow is closed."""
