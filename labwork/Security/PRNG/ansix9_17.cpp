/* X9.17 Pseudo Random Number Generator
 * Author: Rohit Yadav <rohityadav89@gmail.com>
 *         07020003, IDD Part IV
 */
...
void Des::PermChoice1(int *key) //Permutation Choice-1
{
	int k=57,i;
	for(i=0;i<28;i++)
	{
...
//	 ofstream fout("out2_fil.txt"); fout<<str1; fout.close();
 ...
 str3=d2.EDE(str2);
 //cout<<"\ni/p Text: "<<str2<<endl;
 cout<<"\nRandom Number : "<<str3<<endl;
  //Third EDE
  for(i=0;i<8;i++)
  	str4[i] = str1[i] ^ str3[i];
  v=d3.EDE(str4);
 //cout<<"\ni/p Text: "<<str4<<endl;
 cout<<"\nNext Seed  : "<<v<<endl;
